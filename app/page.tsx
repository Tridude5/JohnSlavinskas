        ...
        <div className="container py-16 md:py-24">
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link href="/resume" className="btn">{t('hero.viewResume')}</Link>
              <a href={`${base}/downloads/John_Slavinskas_Resume_1p.pdf`} className="btn-outline">{t('hero.download1p')}</a>
              <a href={`${base}/downloads/John_Slavinskas_CV.pdf`} className="btn-outline">{t('hero.downloadCV')}</a>
            </div>
          </div>
        </div>
